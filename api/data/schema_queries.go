...
// 			if err := tools.ValidateColumnName(new); err != nil {
// 				return nil, err
// 			}
...
// 				return nil, tools.InvalidTypeErr(name, col.Type)
// 			}
...
// 	if changes.NewName != "" {
// 		if err := tools.ValidateTableName(changes.NewName); err != nil {
// 			return nil, err
// 		}
...
// 		if err := tools.ValidateColumnName(n); err != nil {
// 			return nil, err
// 		}
// 		if mapColType(col.Type) == "" {
// 			return nil, tools.InvalidTypeErr(n, col.Type)
// 		}
